...
public class AndPermissionHelper {
    ...
    public static void mainActivityRequest(AppCompatActivity activity, AndPermissionHelperListener1 listener1) {
        String[] permissions = new String[]{
                Manifest.permission.WRITE_EXTERNAL_STORAGE,
        };

        HashMap<String, Integer> rationales = new HashMap<>(1);
        rationales.put(Manifest.permission.WRITE_EXTERNAL_STORAGE, R.string.permission_dialog_rationale_file_access);
    ...
    private static class AndPermissionRequest {
        ...
        private void showSetting() {
            ...
            dialog.showAllowingStateLoss(mFragmentManager, null);
        }
    ...
    public static class RationaleDialog extends PreventRestoreDialogFragment {
    ...
    public static class SettingDialog extends PreventRestoreDialogFragment {
